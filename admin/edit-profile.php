...
<html lang="en">
    <head>
        ...
        <title>แก้ไขผู้เข้าใช้งาน</title>
                     ...
                     <form method="post">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="update">แก้ไขผู้เข้าใช้งาน</button></td>
