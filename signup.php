...
<h2 align="center">ระบบลงทะเบียนฉีดวัคซีน จังหวัดหนองคาย</h2>
<hr />
                                        <h3 class="text-center font-weight-light my-4">สร้างบัญชีผู้ใช้งาน</h3></div>
                                    <div class="card-body">
...
<label for="inputcontact">หมายเลขโทรศัพท์</label>
</div>
...
<div class="mt-4 mb-0">
<div class="d-grid"><button type="submit" class="btn btn-primary btn-block" name="submit">สร้างบัญชีผู้ใช้งาน</button></div>
</div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
 <div class="small"><a href="login.php"> หน้าล็อคอิน </a></div>
  <div class="small"><a href="index.php">หน้าหลัก</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
