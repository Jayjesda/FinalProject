                                ...
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       ...
                                       <td colspan="3"><?php echo $result['email'];?></td>
                                        ...
                                        <tr>
                                       <th>วัน/เดือน/ปี การสมัคร</th>
                                       <td colspan="3"><?php echo $result['posting_date'];?></td>
                                   </tr>
                                   <tr>
                                       <td colspan="4" style="text-align:center ;"><button type="submit" class="btn btn-primary btn-block" name="update">แก้ไขข้อมูลส่วนตัว</button></td>
